...
public class Utilities {
	...
	public static void StoreNetwork(String file_name, NeuralNetwork network) {
		try{
		...
		writer.close();
			...
			System.out.println("");
			System.out.println("#### ERROR:Error reading the file: "+ file_name+". It's look like dosen't exists");
			System.out.println("");
		}
	}
	...
	public static NeuralNetwork loadNeuralNetwork(String file){
		try{
		...
		return net;
			...
			System.out.println("");
			System.out.println("#### ERROR:Error reading the file: "+ file+". It's look like dosen't exists");
			System.out.println("");
			return null;
		}
	}
